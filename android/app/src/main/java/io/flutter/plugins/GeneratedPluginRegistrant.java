...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.quickblox.quickblox_sdk.QuickbloxSdkPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin quickblox_sdk, com.quickblox.quickblox_sdk.QuickbloxSdkPlugin", e);
    }
    try {
